...
const Login = () => {
    ...
    return (
        <div className="header page">
            ...
            <form className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center bg-black bg-opacity-70 p-8 rounded-lg w-80 h-300">
                ...
                <input type="text" placeholder="Email or mobile number" className="p-3 m-3 text-white bg-gray-700 w-full rounded"/>
                <input type="password" placeholder="Password" className="p-3 m-3 text-white bg-gray-700 w-full rounded"/>
                <button className="p-3 m-3 w-full bg-red-600 text-white rounded hover:bg-red-700">{ isSignInForm ? "Sign In" : "Sign Up"}</button>
